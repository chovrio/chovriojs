...
// ../../packages/plugins/vue-parse-plugin/dist/index.js
var import_fs_extra = __toESM(require_lib(), 1);
function vueParsePlugin() {
  return {
...
// chovrio.config.js
var chovrio_config_default = {
  plugins: [vueParsePlugin()]
};

export { chovrio_config_default as default };
